        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="text-lg font-medium leading-6 text-gray-900">Create a category</h3>
              <p className="mt-1 text-sm text-gray-600">Be sure to be logged in to create a new category</p>
            </div>
          </div>
